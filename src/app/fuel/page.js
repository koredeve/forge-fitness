...
export default function Fuel() {
  return (
    <AuthGate
      title="Fuel & Recovery Protocols"
      subtitle="Sign in to access athlete nutrition guidelines, macronutrient formulas, hydration targets, and tendon recovery protocols."
      icon="🍎"
    >
